...
export interface WorkbenchSegment { readonly segmentId: string; readonly chapterId: string; readonly chapterOrdinal: number; readonly segmentOrdinal: number; readonly sourceBlockId?: string; readonly tagName?: string; readonly isTitle?: boolean; readonly sourceText: string; readonly originalTranslation: string | null; readonly selectedTranslation: string | null; readonly status: string; readonly versionCount: number; readonly openReviewCount: number; }
